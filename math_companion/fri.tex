...
The security level is calculated in \verb|zkvms/fri_based_vm.py/get_security_levels()|.
...
This calculation is performed in \verb|fri.py/get_FRI_proof_size_bits()|.
