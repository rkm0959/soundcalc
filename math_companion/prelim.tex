...
$$
\ebatchpowJ(\rho,N,q,B), \quad \ebatchpowU(\rho,N,q,B),\quad \ebatchlinU(\rho,N,q),\quad \ebatchpowU(\rho,N,q,B), \quad \ebatchmulU(\rho, N, q, B)
$$
For JBR :
\begin{itemize}
...
For UDR :
\begin{itemize}
    \item Compute linear error\footnote{Code refers to Theorem 4.1 from BCHKS25}:
    $$
