...
For parameters:
\begin{itemize}
    \item Number of columns: $C=$ \verb|num_columns|
    \item AIR degree: $d =$ \verb|AIR_max_degree|
    \item Trace increase constant [Hab22, Remark7]: $m_c$ \verb|max_combo|
    \item Trace length: $N$
    \item List size: $\ell$ as in \cref{sec:fri_list_sizes}
\end{itemize}
